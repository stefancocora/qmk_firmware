 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | Esc    |   1  |   2  |   3  |   4  |   5  | Play |           | Mute |   6  |   7  |   8  |   9  |   0  |   -    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Grv  |   |  |Insert| Left | Right|                                       |  Up  | Down |   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        | Ctrl | Alt  |       | Meta | Ctrl   |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_LSFT,         KC_Z,        KC_X,          KC_C,    KC_V,    KC_B,    TG(COLH),             KC_PEQL,      KC_N,    KC_M,    KC_COMM, KC_DOT,            KC_SLSH,        KC_RSFT,
  KC_GRV,          KC_BSLS,     KC_INS,        KC_LEFT, KC_RGHT,                                              KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, TG(COLH),
...
/* Keymap 3: Colemak US hardware
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | Esc    |   1  |   2  |   3  |   4  |   5  | Play |           | Mute |   6  |   7  |   8  |   9  |   0  |   -    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   F  |   P  |   G  |  L1  |           |  L2  |   J  |   L  |   U  |   Y  |   ;  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 ...
 *                                 `--------------------'       `----------------------'
 */
[COLH] = LAYOUT_ergodox_pretty(
  // left hand
  KC_ESC,          KC_1,        KC_2,          KC_3,    KC_4,    KC_5,    KC_MPLY,              KC_MUTE,      KC_6,    KC_7,    KC_8,    KC_9,              KC_0,           KC_MINS,
  KC_TAB,          KC_Q,        KC_W,          KC_F,    KC_P,    KC_G,    TG(SYMB),             TG(MDIA),     KC_J,    KC_L,    KC_U,    KC_Y,              KC_SCLN,        KC_BSLS,
  KC_ESC,          KC_A,        KC_R,          KC_S,    KC_T,    KC_D,                                        KC_H,    KC_N,    KC_E,    KC_I,              KC_O,           KC_QUOT,
  KC_LSFT,         KC_Z,        KC_X,          KC_C,    KC_V,    KC_B,    TG(COLH),             KC_PEQL,      KC_K,    KC_M,    KC_COMM, KC_DOT,            KC_SLSH,        KC_RSFT,
  KC_GRV,          KC_BSLS,     KC_INS,        KC_LEFT, KC_RGHT,                                              KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, TG(COLH),
                                                           KC_LCTL,       KC_LALT,                 KC_LGUI,   KC_RCTL,
                                                                          KC_HOME,                 KC_PGUP,
                                                         KC_BSPC, KC_DEL,  KC_END,                  KC_PGDN, KC_ENT, KC_SPC
